										...
										if (isset($subcategories2)) {
											for ($l = 0; $l < $menu_item['column'][$i]['limit']; $l++) {
												if (isset($subcategories2[$l])) {
													...
													$href = $this->url->link('product/category', 'path=' . $subcategories2[$l]['category_id']);
													$list .= "<li>\n<a href=\"" . $href . "\">" . $subcategory_name . "</a>\n</li>\n";
												}
											}
										}
									...
									if (isset($subcategories)) {
										...
										for ($l = $subcategory_count; $l < $tmp; $l++) {
											if (isset($subcategories[$l])) {
												...
												$parent_href = $this->url->link('product/category', 'path=' . $subcategories[$l]['category_id']);
												$list .= "<li>\n<a href=\"" . $parent_href . "\">" . $subcategory_name . "</a>\n</li>\n";
											}
											$subcategory_count++;
										}
									}
