...
class ControllerModuleTMBlogArticles extends Controller
{
    ...
    public function index($setting)
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/tm_blog_articles.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/module/tm_blog_articles.tpl', $data);
        } else {
            return $this->load->view('default/template/module/tm_blog_articles.tpl', $data);
        }
    }
}
