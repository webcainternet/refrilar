...
<div class="container">
	...
	<div class="alert alert-info">
		<i class="material-design-round52"></i> ' + json['info'] + '<button type="button" class="close material-design-close47"></button>
	</div>
	<?php } ?>
	<?php if ($success) { ?>
	<div class="alert alert-success">
		<i class="material-design-verification24"></i>
		<?php echo $success; ?>
	...
	<div class="alert alert-danger">
		<i class="material-design-cancel19"></i>
			...
			<div class="cart-wrapper">
						...
						<table class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-left">
										<a class="link" href="<?php echo $product['href']; ?>">
										...
										<br/>
										<small>
											<strong><?php $strarr = explode(':', $product['reward'], 2); echo $strarr[0] . ':'; ?></strong>
											<?php echo $strarr[1] ?>
										</small>
										<?php } ?>
									...
									<td class="text-center" style="width: 0">
										<button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="cart-remove-btn" onclick="cart.remove('<?php echo $product['cart_id']; ?>');">
											<i class="material-design-rubbish"></i>
										</button>
									</td>
								</tr>
								<?php } ?>
				...
				<div class="buttons">
					...
					<div class="pull-right">
						<a href="<?php echo $checkout; ?>" class="btn btn-primary checkout">
