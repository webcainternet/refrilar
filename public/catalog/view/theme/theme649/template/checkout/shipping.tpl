		...
		success: function(json) {
			...
			if (json['error']) {
				if (json['error']['warning']) {
					$('.breadcrumb').after('<div class="alert alert-danger"><i class="material-design-cancel19"></i> ' + json['error']['warning'] + '<button type="button" class="close material-design-close47" data-dismiss="alert"></button></div>');
...
$(document).delegate('#button-shipping', 'click', function() {
	$.ajax({
		...
		success: function(json) {
			...
			if (json['error']) {
				$('.breadcrumb').after('<div class="alert alert-danger"><i class="material-design-cancel19"></i> ' + json['error'] + '<button type="button" class="close material-design-close47" data-dismiss="alert"></button></div>');
