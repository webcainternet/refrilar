					...
					<li class="sf-mega_row">
						...
						<li class="sf-mega_row">
							...
							<div class="sf-mega_section" style="width: <?php echo $column['width']; ?>">
								...
								<?php if (!empty($column['list'])) { ?>
								<ul>
									<li class="category-name"><?php echo $menu_parent_name; ?></li>
									<?php if (!empty($column['subcategory'])) { ?>
									<li class="submenu_title"><a href="<?php echo $column['subcategory_href'] ?>"><?php echo $column['subcategory']['name']; ?></a></li>
									<?php } ?>
