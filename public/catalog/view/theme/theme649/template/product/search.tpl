	  ...
	  <div class="row"> 
		<?php $pr = 10000; foreach ($products as $product) { $pr++;?>
                        ...
                        <?php if ($product['rating']) { ?>
                            <div class="rating">
                                <?php for ($i = 1; $i <= 5; $i++) { ?>
                                    ...
                                    <?php } else { ?>
                                          <span class="fa-stack"><i class="material-icons-star   fa-stack-1x"></i>
          ...
          <button class="product-btn-add" type="button" data-toggle="tooltip" title="<?php echo $button_cart; ?>" <?php if (count($product['options']) >= 4) { ?> onclick="cart.add('<?php echo $product['product_id']; ?>');" <?php } else { ?> onclick="ajaxAdd($(this),<?php echo $product['product_id'] ?>);" <?php } ?> >
                ...
                <div class="aside">
                  <div class="cart-button">
                    <button class="product-btn-add" type="button" title="<?php echo $button_cart; ?>" <?php if (count($product['options']) >= 4) { ?> onclick="cart.add('<?php echo $product['product_id']; ?>');" <?php } else { ?> onclick="ajaxAdd($(this),<?php echo $product['product_id'] ?>);" <?php } ?> >
                                                <i class="material-icons-add_shopping_cart"></i>
                                                <span><?php echo $button_cart; ?></span>
                                            </button>
                    <button class="product-btn" type="button"  title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="material-icons-favorite_border"></i><span><?php echo $button_wishlist; ?></span></button>
                    <button class="product-btn" type="button"  title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="material-icons-equalizer"></i><span><?php echo $button_compare; ?></span></button>
                  </div>
                </div>
                </div>
                <div class="clear"></div>
