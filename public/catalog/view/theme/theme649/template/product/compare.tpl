                                                    ...
                                                    <?php for ($i = 1; $i <= 5; $i++) { ?>
                                                        <?php if ($products[$product['product_id']]['rating'] < $i) { ?>
                                                            <span class="fa-stack"><i
                                                                    class="material-icons-star fa-stack-2x"></i></span>
                                                        <?php } else { ?>
                                                            <span class="fa-stack"><i
                                                                    class="material-icons-star fa-stack-2x"></i><i
                                                                    class="material-icons-star star fa-stack-2x"></i></span>
                                                        <?php } ?>
                                                    <?php } ?>
                                ...
                                <?php foreach ($products as $product) { ?>
                                    <td class="text-center">
                                        <button type="button"
                                                ...
                                                onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="material-design-shopping231"></i><?php echo $button_cart; ?></button>
                                    </td>
                                <?php } ?>
                            </tr>
                        </table>
