			...
			<div class="form-group">
				...
				<article class="article-info">
					...
					<div class="article-sub-title">
						...
						<span class="article-comments material-design-add183"><?php echo $total_comment; ?></span>
						<?php } ?>
					...
					<?php if ($products || ($simple_blog_related_articles) && ($related_articles) || $simple_blog_author_information || $article_info['allow_comment']) { ?>

					<div class="product_tabs">
						<ul class="nav nav-tabs">
							<?php if ($products) { ?>
							<li>
								<a href="#tab-products" data-toggle="tab"><?php echo $text_related_product; ?></a>
							</li>
							<?php } ?>
							<?php if (($simple_blog_related_articles) && ($related_articles)) { ?>
							<li>
								<a href="#tab-articles" data-toggle="tab"><?php echo $text_related_article; ?></a>
							</li>
							<?php } ?>
							<?php if ($simple_blog_author_information) { ?>
							<li>
								<a href="#tab-author" data-toggle="tab"><?php echo $text_author_information;; ?></a>
							</li>
							<?php } ?>
							<?php if ($article_info['allow_comment']) { ?>
							<li>
								<a href="#tab-comments" data-toggle="tab"><?php echo $text_related_comment; ?></a>
							</li>
							<?php } ?>
						</ul>
						...
						<div class="tab-content">
							...
							<div id="tab-articles" class="tab-pane related-article">
								...
								<div class="row">
									...
									<div class="box col-sm-12 col-md-6">
										...
										<div class="article-sub-title">
											<span class="article-date material-design-clock100"><?php echo $related_article['date_added']; ?></span>
											<span class="article-comments material-design-add183">
												<a href='<?php echo $related_article['article_href']; ?>#comment-section'><?php echo $related_article['total_comment'] . $text_comment_on_article; ?></a>
											</span>
										...
										<div class="related-article-button">
											<a href="<?php echo $related_article['article_href']; ?>" class="btn"><?php echo $button_continue_reading; ?></a>
										</div>
									</div>
							...
							<div id="tab-author" class="tab-pane author-info">
								...
								<div class="image">
									<img src="<?php echo $author_image; ?>" alt="<?php echo $article_info['article_title']; ?>"/>
								</div>
								<?php } ?>
							...
							<div id="tab-comments" class="tab-pane">
								...
								<div class="form-group">
									<div id="comments" class="blog-comment-info">
										...
										<h2 id="review-title">
											<span><?php echo $text_write_comment; ?></span>
