<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    <div class="tm-login-form">
        ...
        <input type="text" name="header-login-email" value="<?php echo $email; ?>" placeholder="<?php echo $entry_email; ?>"
               id="input-email" class="form-control"/>
    </div>
    <div class="tm-login-form">
        <label class="control-label" for="input-password"></label>
        <input type="password" name="header-login-password" value="<?php echo $password; ?>"
    ...
    <?php if ($redirect) { ?>
        <input type="hidden" name="header-login-redirect" value="<?php echo $redirect; ?>"/>
    <?php } ?>
</form>
