...
$_['text_success'] = 'Secure Trading Payment Pages modificado com sucesso!';
...
$_['error_permission'] = 'Atenção: Você não tem permissão para modificar a extensão de pagamento Secure Trading Payment Pages!';
