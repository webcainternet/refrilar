<?php
/**
 * @version		$Id: pp_pro.php 3754 2014-10-01 20:12:29Z mic $
...
$_['text_pp_pro']			= '<a href="https://www.paypal.com/uk/mrb/pal=V4T754QB63XXL" target="_blank"><img src="view/image/payment/paypal.png" alt="PayPal Website Payment Pro" title="PayPal Website Payment Pro" style="border: 1px solid #EEEEEE;" /></a>';
...
// Help
$_['entry_test_help']		= 'Entweder Live- oder Testmodus (Sandbox) anwenden';
$_['entry_total_help']		= 'Gesamtsumme Brutto des Warenkorbs damit diese Zahlungsart verfügbar ist';
