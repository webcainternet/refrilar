						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-left"><?php echo $comment['article_title']; ?> <?php echo  ($comment['reply_unchecked'] > 0 ? '<span class="label label-info" data-toggle="tooltip" title="'. $text_reply_unchecked .'">' . $comment['reply_unchecked'] . '</span>' : '')?> </td>
